...
Original file is located at
    https://colab.research.google.com/drive/13YtaMFpXYH4jmMOJF6q4dQaWOI7xdKht
...
import pandas as pd
df.to_csv("C:\Project\flipkart.csv")

"""To check the csv file 

*   Click on 3 dots of left side
*   Click on file icon 
*   You can get there .csv file 
